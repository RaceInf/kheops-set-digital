...
const HeroSection = () => {
  ...
  const images = [
    '/images/og/home.jpg',
    '/images/articles/strategie-facebook-2025.jpg',
    '/images/articles/page_pro.jpg',
  ];
    ...
    <section className="relative overflow-hidden pt-32 pb-20 md:pt-40 md:pb-32" ref={heroRef}>
      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div
              className="relative z-10 bg-white p-2 rounded-2xl shadow-2xl overflow-hidden"
            >
              <div className="relative w-full h-auto">
                {images.map((src, idx) => (
                  <motion.img
                    ...
                    className={`rounded-xl w-full h-auto absolute inset-0 ${idx === 0 ? '' : ''}`}
